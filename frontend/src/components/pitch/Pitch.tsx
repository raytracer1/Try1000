...
const POSITIONS: Record<string, { x: number; y: number }[]> = {
  "4-3-3": [{x:5,y:32},{x:20,y:20},{x:20,y:44},{x:25,y:6},{x:25,y:58},{x:38,y:32},{x:52,y:18},{x:52,y:46},{x:70,y:8},{x:70,y:56},{x:85,y:32}],
  "4-4-2": [{x:5,y:32},{x:20,y:20},{x:20,y:44},{x:25,y:6},{x:25,y:58},{x:45,y:10},{x:45,y:54},{x:55,y:22},{x:55,y:42},{x:78,y:22},{x:78,y:42}],
  "3-5-2": [{x:5,y:32},{x:20,y:20},{x:20,y:44},{x:28,y:32},{x:45,y:8},{x:45,y:56},{x:52,y:22},{x:52,y:42},{x:40,y:32},{x:80,y:22},{x:80,y:42}],
  "4-2-3-1":[{x:5,y:32},{x:20,y:20},{x:20,y:44},{x:25,y:6},{x:25,y:58},{x:42,y:22},{x:42,y:42},{x:60,y:10},{x:55,y:32},{x:60,y:54},{x:85,y:32}],
  "3-4-3": [{x:5,y:32},{x:20,y:20},{x:20,y:44},{x:40,y:8},{x:40,y:56},{x:48,y:22},{x:48,y:42},{x:70,y:10},{x:70,y:54},{x:62,y:22},{x:62,y:42},{x:55,y:32}],
};
